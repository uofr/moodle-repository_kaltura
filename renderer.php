...
class mod_kalvidres_renderer extends plugin_renderer_base {
    ...
    public function embed_media($kalvidres) {
        ...
        if (!empty($entry_obj)) {
            ...
            if (KalturaMediaType::IMAGE == $entry_obj->mediaType) {
                ...
                if (0 == strcmp($theme, 'mymobile')) {
                    $markup = local_kaltura_get_kwidget_code($entry_obj, $kalvidres->uiconf_id, $courseid, $session, 0, $doShowPreview);
                } else {
                    $markup = local_kaltura_get_kdp_code($entry_obj, $kalvidres->uiconf_id, $courseid, $session, 0, $doShowPreview);
                }
            }
