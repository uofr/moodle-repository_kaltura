...
$string['modulename_help'] = 'Add media to your course by uploading video or make a recording directly from your webcam. Content is stored locally on the institution\'s Kaltura CE (<a href="https://urcourses-video.uregina.ca">urcourses-video.uregina.ca</a>) server.';
...
$string['media_select'] = 'Select From MyMedia';
$string['media_upload'] = 'Upload From Your Device';
$string['webcam_upload'] = 'Record From Your Device';
...
$string['invalid_ipaddress'] = 'Sorry, this media is only available for a certain local area.<br>Your IP address is out of the range of this local area.<br>';
$string['plays'] = 'Plays';
$string['views'] = 'Views';
