...
$filename = "kalvidres_logs_" . $course->shortname . "_";
...
if (($admin == true || ($userrole != 'student' && $userrole != 'guest')) && !empty($kalvidres)) {
    if (!empty($kalvidres->entry_id)) {
        ...
        $worksheet[0]->write_string(0, 3, get_string('plays', 'kalvidres'));
        $worksheet[0]->write_string(0, 4, get_string('views', 'kalvidres'));
